...
EVENT_GROUP_LOAD = 29
EVENT_GROUP_REFRESH = 30
EVENT_DUNGEON_REWARD_GET = 31
EVENT_SPECIFIC_GADGET_HP_CHANGE = 32
EVENT_MONSTER_TIDE_OVER = 33
EVENT_MONSTER_TIDE_CREATE = 34
EVENT_MONSTER_TIDE_DIE = 35
EVENT_SEALAMP_PHASE_CHANGE = 36
...
PlatformRotType:
PLATFORM_ROT_NONE = 0
PLATFORM_ROT_SPEED = 1
PLATFORM_ROT_ROUND = 2
